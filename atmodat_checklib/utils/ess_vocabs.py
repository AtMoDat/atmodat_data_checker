...
class ESSVocabs(object):
    ...
    def check_global_attribute(self, ds, attr, vocab_term=None, property="label"):
        ...
        nc_attr = ds.getncattr(attr).lower()
    ...
    def check_file_name(self, filename, keys=None, delimiter="_", extension=".nc"):
        ...
        :param keys: sequence of attribute keys to look-up values from in CVs.
        :param delimiter: string used as delimiter in file name: string.
