...
setup(
    ...
    scripts=["run_checks.py", "atmodat_checklib/utils/fill_attributes/fill_global_attributes.py",
             "atmodat_checklib/utils/fill_attributes/fill_variable_attributes.py"],
